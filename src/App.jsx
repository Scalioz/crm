...
function AppRoutes() {
  ...
  const [theme, setTheme] = useState(
    () => window.localStorage.getItem("crm-theme") || "light"
  );
  ...
  const updateLead = async (leadId, updates, description = "Lead updated.") => {
    ...
    const nextLead = {
      ...
      activity: [
        ...
        createActivityEntry("Lead updated", description),
      ],
    };
        ...
        lead.id === leadId
          ? {
              ...
              activity: [
                ...
                createActivityEntry(
                  "Note added",
                  `Added note: ${noteText.slice(0, 80)}`
                ),
              ],
            }
          : lead
  ...
  return (
    <div className={isPublicRoute ? "public-shell" : "app-shell"}>
      {!isPublicRoute && (
        <Sidebar
      ...
      <main className={isPublicRoute ? "public-main" : "main-shell"}>
        {!isPublicRoute && (
          <Topbar
        ...
        <div className={isPublicRoute ? "public-page-frame" : "page-frame"}>
          <Routes>
            ...
            <Route
              ...
              element={
                <ProtectedRoute>
                  <Pipeline leads={leads} onUpdateStatus={updateLead} />
                </ProtectedRoute>
              }
            />
            ...
            <Route
              ...
              element={
                <ProtectedRoute>
                  <Tasks leads={leads} onCompleteFollowUp={clearFollowUp} />
                </ProtectedRoute>
              }
            />
            ...
            <Route
              ...
              element={
                <ProtectedRoute>
                  <Placeholder title="Messages" subtitle="Message center" />
                </ProtectedRoute>
              }
            />
